        ...
        <footer className="mt-auto w-full max-w-[85rem] py-5 px-4 sm:px-6 lg:px-8 mx-auto font-mono">
            <div className="text-center">
                ...
                <div className="mt-3 space-x-2">
                    <a className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-white hover:bg-orange-400 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="https://github.com/">
